...
//A5 Flooded Temple. 2 Gamma Metroids remove.
if (global.lavastate == 7) {
        //if (global.metdead[33] == 1 && global.metdead[34] == 1 && global.metdead[35] == 1 && global.metdead[36] == 1 && global.metdead[37] == 1 && global.metdead[38] == 1) {
    //This has been changed in order to make NewGame+ work correctly. Lava State needs to start at 7.
    if (global.metdead[0] == 1 && global.metdead[1] == 1 && global.metdead[2] == 1 && global.metdead[3] == 1 && global.metdead[4] == 1 && global.metdead[5] == 1 && global.metdead[6] == 1 && global.metdead[7] == 1 && global.metdead[8] == 1 && global.metdead[9] == 1 && global.metdead[10] == 1 && global.metdead[11] == 1 && global.metdead[12] == 1 && global.metdead[13] == 1 && global.metdead[14] == 1 && global.metdead[15] == 1 && global.metdead[16] == 1 && global.metdead[17] == 1 && global.metdead[18] == 1 && global.metdead[19] == 1 && global.metdead[20] == 1 && global.metdead[21] == 1 && global.metdead[22] == 1 && global.metdead[23] == 1 && global.metdead[24] == 1 && global.metdead[25] == 1 && global.metdead[26] == 1 && global.metdead[27] == 1 && global.metdead[28] == 1 && global.metdead[29] == 1 && global.metdead[30] == 1 && global.metdead[31] == 1 && global.metdead[32] == 1 && global.metdead[33] == 1 && global.metdead[34] == 1 && global.metdead[35] == 1 && global.metdead[36] == 1 && global.metdead[37] == 1 && global.metdead[38] == 1) { 
        instance_create(0, 0, oBigQuake);
        global.lavastate = 8;
    }
}
