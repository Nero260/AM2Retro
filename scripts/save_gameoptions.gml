...
ini_write_real("Screen", "ShowMedalMessage", global.ophudshowmedalmsg); // Unused and basically remove.
...
ini_write_real("Sound", "SoundEffects", global.opsoundfx); // Unused.
...
ini_write_real("Extras", "3DFilter", oControl.mod_3D); // added
ini_write_real("Extras", "AltSpeedbooster", oControl.mod_sprintanimation); // added
ini_write_real("Extras", "EtankSwapper", oControl.mod_etankswapper); // added
