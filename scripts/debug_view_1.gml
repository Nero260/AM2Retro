...
if (instance_exists(oCharacter) && instance_exists(oCamera) && global.ingame) {
    ...
    if (instance_exists(oQueen)) {
        ...
        debug_draw_var("Height Back: ", oQueen.height_back); // change
    }
    ...
    if (instance_exists(oEris)) {
        ...
        debug_draw_var("State: ", oEris.state);
        debug_draw_var("StateTime: ", oEris.statetime);
        debug_draw_var("target: ", oEris.tgt);
        debug_draw_var("HP: ", oEris.hp);
    }
    ...
    /*if (instance_exists(oAlphaMoto)) {
        debug_draw_var("ALPHA MOTO", "-----------------------------");
        debug_draw_var("State: ", oMotoAdult.state);
        debug_draw_var("StateTime: ", oMotoAdult.statetime);
        debug_draw_var("HP: ", oMotoAdult.hp);
        debug_draw_var("turningiframe:", oMotoAdult.turningiframe);
}*/
//} // if (instance_exists(oCharacter) && instance_exists(oCamera) && global.ingame)
