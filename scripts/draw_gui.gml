/// draw_gui()
if (global.classicmode == 0 && global.opshowhud) { // global.classicmode
xoff = 38; //33;
...
if (global.etanks >= 1 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9) draw_sprite(sGUIETankRED, 1, 0 + etankxoff, 4);
if (global.playerhealth <= 99.9) draw_sprite(sGUIETankRED, 0, 0 + etankxoff, 4);
}
if (global.etanks >= 2) {
if (global.playerhealth > 99.9 + (100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff, 10);
if (global.playerhealth <= 99.9 + (100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff, 10);
}
if (global.etanks >= 2 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff, 10);
if (global.playerhealth <= 99.9 + (100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff, 10);
}
if (global.etanks >= 3) {
if (global.playerhealth > 99.9 + (200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 6, 4);
if (global.playerhealth <= 99.9 + (200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 6, 4);
}
if (global.etanks >= 3 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 6, 4);
if (global.playerhealth <= 99.9 + (200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 6, 4);
}
if (global.etanks >= 4) {
if (global.playerhealth > 99.9 + (300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 6, 10);
if (global.playerhealth <= 99.9 + (300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 6, 10);
}
if (global.etanks >= 4 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 6, 10);
if (global.playerhealth <= 99.9 + (300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 6, 10);
}
if (global.etanks >= 5) {
if (global.playerhealth > 99.9 + (400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 12, 4);
if (global.playerhealth <= 99.9 + (400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 12, 4);
}
if (global.etanks >= 5 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 12, 4);
if (global.playerhealth <= 99.9 + (400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 12, 4);
}
if (global.etanks >= 6) {
if (global.playerhealth > 99.9 + (500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 12, 10);
if (global.playerhealth <= 99.9 + (500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 12, 10);
}
if (global.etanks >= 6 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 12, 10);
if (global.playerhealth <= 99.9 + (500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 12, 10);
}
if (global.etanks >= 7) {
if (global.playerhealth > 99.9 + (600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 18, 4);
if (global.playerhealth <= 99.9 + (600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 18, 4);
}
if (global.etanks >= 7 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 18, 4);
if (global.playerhealth <= 99.9 + (600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 18, 4);
}
if (global.etanks >= 8) {
if (global.playerhealth > 99.9 + (700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 18, 10);
if (global.playerhealth <= 99.9 + (700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 18, 10);
}
if (global.etanks >= 8 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 18, 10);
if (global.playerhealth <= 99.9 + (700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 18, 10);
}
if (global.etanks >= 9) {
if (global.playerhealth > 99.9 + (800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 24, 4);
if (global.playerhealth <= 99.9 + (800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 24, 4);
}
if (global.etanks >= 9 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 24, 4);
if (global.playerhealth <= 99.9 + (800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 24, 4);
}
if (global.etanks >= 10) {
if (global.playerhealth > 99.9 + (900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 24, 10);
if (global.playerhealth <= 99.9 + (900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 24, 10);
}
if (global.etanks >= 10 && oControl.mod_etankswapper) {
if (global.playerhealth > 99.9 + (900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 1, 0 + etankxoff + 24, 10);
if (global.playerhealth <= 99.9 + (900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETankRED, 0, 0 + etankxoff + 24, 10);
}
/*if (global.etanks > 10)
{
    if (global.etanks >= 11) {
    if (oControl.mod_etankswapper) == sGUIETankRED;
    if (global.playerhealth > 99.9 + (1000 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 33, 4);
    if (global.playerhealth <= 99.9 + (1000 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 33, 4);
    }
    if (global.etanks >= 12) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 33, 10);
    if (global.playerhealth <= 99.9 + (1100 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 33, 10);
    }
    if (global.etanks >= 13) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 39, 4);
    if (global.playerhealth <= 99.9 + (1200 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 39, 4);
    }
    if (global.etanks >= 14) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 39, 10);
    if (global.playerhealth <= 99.9 + (1300 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 39, 10);
    }
    if (global.etanks >= 15) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 45, 4);
    if (global.playerhealth <= 99.9 + (1400 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 45, 4);
    }
    if (global.etanks >= 16) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 45, 10);
    if (global.playerhealth <= 99.9 + (1500 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 45, 10);
    }
    if (global.etanks >= 17) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 51, 4);
    if (global.playerhealth <= 99.9 + (1600 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 51, 4);
    }
    if (global.etanks >= 18) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 51, 10);
    if (global.playerhealth <= 99.9 + (1700 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 51, 10);
    }
    if (global.etanks >= 19) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 57, 4);
    if (global.playerhealth <= 99.9 + (1800 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 57, 4);
    }
    if (global.etanks >= 20) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
    if (global.playerhealth > 99.9 + (1900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 1, 0 + etankxoff + 57, 10);
    if (global.playerhealth <= 99.9 + (1900 * oControl.mod_etankhealthmult)) draw_sprite(sGUIETank, 0, 0 + etankxoff + 57, 10);
    }
    if (global.etanks >= 21) {
    if (oControl.mod_etankswapper) = sGUIETankRED;
...
xoff += 38; // added for the beam hud.
}

// Beam Checking

if (global.opshowhud == 1) {
draw_background(bgGUIBeam, xoff, 0);

//Wave

if (global.item[12] == 0 ) {
draw_sprite(sGUIWBeam, 0, xoff + 3, 4);
} else if (global.item[12] == 1) {
draw_sprite(sGUIWBeam, 1, xoff + 3, 4);
}

//Spazer

if (global.item[13] == 0) {
draw_sprite(sGUISBeam, 0, xoff + 16, 4);
} else if (global.item[13] == 1) {
draw_sprite(sGUISBeam, 1, xoff + 16, 4);
}

//Plasma

if (global.item[14] == 0) {
draw_sprite(sGUIPBeam, 0, xoff + 29, 4);
} else if (global.item[14] == 1) {
draw_sprite(sGUIPBeam, 1, xoff + 29, 4);
}

//Ice

if (global.item[11] == 0) {
draw_sprite(sGUIIBeam, 0, xoff + 42, 4);
} else if (global.item[11] == 1) {
draw_sprite(sGUIIBeam, 1, xoff + 42, 4);
}
}
...
if (global.ophudshowmetrcount == 1 && oControl.mod_monstersextremecheck == 0) {
...
//
if (global.ophudshowmetrcount == 1 && oControl.mod_monstersextremecheck == 1) {
draw_background(bgGUIMetCountBG1ELM, xoff + 4 + widescreen_space, 4);
draw_text(xoff + 6 + widescreen_space, 21, to_string_lz(global.monstersarea));
//
}
if (global.ophudshowmetrcount == 2 && oControl.mod_monstersextremecheck == 0) {
...
//
if (global.ophudshowmetrcount == 2 && oControl.mod_monstersextremecheck == 1) {
draw_background(bgGUIMetCountBG2ELM, xoff + 4 + widescreen_space, 4);
draw_text(xoff + 6 + widescreen_space, 21, to_string_lz(global.monstersleft));
//
}
}
