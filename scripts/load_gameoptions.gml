...
set_default_joypad();
set_default_xjoypad();
if (!file_exists(working_directory + "/am2retro/configR.ini")) save_gameoptions(); // config.ini
if (file_exists(working_directory + "/am2retro/configR.ini")) { // config.ini
    ini_open("am2retro/configR.ini"); // config.ini
    ...
    global.ophudshowmedalmsg = ini_read_real("Screen", "ShowMedalMessage", 1); //Unused.
    ...
    global.opsoundfx = ini_read_real("Sound", "SoundEffects", 0); //Unused.
    ...
    oControl.msr_fusionsuit = ini_read_real("Extras", "FusionSuitMSR", 1);
    ...
    oControl.mod_3D = ini_read_real("Extras", "3DFilter", 0); // added
    oControl.mod_sprintanimation = ini_read_real("Extras", "AltSpeedbooster", 0); // added
    oControl.mod_etankswapper = ini_read_real("Extras", "EtankSwapper",0); // added
