...
oControl.mod_xcoordinate3D = 57; // added
oControl.mod_ycoordinate3D = 22; // added
...
//To deal with the unused speedbooster animations.
oControl.mod_sprintanimation = 0;

//3D.
oControl.mod_3D = 0;

//E-tanks Swapper Colors.
oControl.mod_etankswapper = 0;
...
oControl.msr_fusionsuit = 1; // og : 0;
...
global.mod_tankHcannon = mod_changes(ini_read_real('Tank', 'HealthCannon', 100), 100);
global.mod_tankHcore = mod_changes(ini_read_real('Tank', 'HealthCore', 100), 100);
...
//AlphaMoto
global.mod_motoadultHealth = mod_changes(ini_read_real('AlphaMoto', 'Health', 300), 300);
global.mod_motoadultDamage = mod_changes(ini_read_real('AlphaMoto', 'Damage', 40), 40);
global.mod_motoadultmaskDamage = mod_changes(ini_read_real('AlphaMoto', 'MaskDamage', 50), 50);
global.mod_motoadultDspike1 = mod_changes(ini_read_real('AlphaMoto', 'SpikeDamage1', 10), 10);
global.mod_motoadultDspike2 = mod_changes(ini_read_real('AlphaMoto', 'SpikeDamage2', 10), 10);
global.mod_motoadultDspike3 = mod_changes(ini_read_real('AlphaMoto', 'SpikeDamage3', 10), 10);
global.mod_motoadultDspike4 = mod_changes(ini_read_real('AlphaMoto', 'SpikeDamage4', 10), 10);
...
//AlphaMoto
global.mod_coreAlphaMotoDamage = ini_read_real("CoreXAlphaMoto", "Damage", 55);
global.mod_coreAlphaMotoHealthBlue = ini_read_real("CoreXAlphaMoto", "HealthBlue", 3);
global.mod_coreAlphaMotoHealthYellow = ini_read_real("CoreXAlphaMoto", "HealthYellow", 4);
global.mod_coreAlphaMotoHealthRed = ini_read_real("CoreXAlphaMoto", "HealthRed", 3);
