...
pic[1, 0] = bgLogImg01;
//
lbl[2] = get_text("Logs", "Magma");
txt[2, 0] = get_text("Logs", "Magma_Text");
pic[2, 0] = bgLogImg02;
//
...
pic[27, 0] = bgLogImg27;
//Flooded Temple. (A5)
lbl[46] = get_text("Logs", "FloodedTemple");
txt[46, 0] = get_text("Logs", "FloodedTemple_Text");
pic[46, 0] = bgLogImg46;
...
pic[30, 0] = bgLogImg30;
lbl[31] = get_text("Logs", "ChozoRobots");
txt[31, 0] = get_text("Logs", "ChozoRobots_Text");
pic[31, 0] = bgLogImg31;
...
pic[38, 0] = bgLogImg38;
                                                  //NEWLOG maybe...
/*lbl[39] = get_text("Logs", "AlphaMoto");
txt[39, 0] = get_text("Logs", "AlphaMoto_Text");
pic[39, 0] = bgLogImg39;*/
                                                  //
