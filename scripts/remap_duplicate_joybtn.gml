...
if (global.opjoybtn_padu == argument0) {
    global.opjoybtn_padu = get_control_joyaxisbtn(global.curropt);
} else if (global.opjoybtn_padd == argument0) {
    global.opjoybtn_padd = get_control_joyaxisbtn(global.curropt);
} else if (global.opjoybtn_padl == argument0) {
    global.opjoybtn_padl = get_control_joyaxisbtn(global.curropt);
} else if (global.opjoybtn_padr == argument0) {
    global.opjoybtn_padr = get_control_joyaxisbtn(global.curropt);
} else if (global.opjoybtn_a == argument0) {
